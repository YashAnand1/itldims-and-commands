...
func main() {
	...
	serverIP := flag.String("ipa", "", "Server IP")   // Add flag for server IP
	attribute := flag.String("attr", "", "Attribute") // Add flag for attribute
	flag.Parse()

	// Check if server IP and attribute are provided
