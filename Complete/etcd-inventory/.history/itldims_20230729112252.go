...
var (
	rootITLDIMS = &cobra.Command{ //type of command
		...
		Run: func(cmd *cobra.Command, args []string) { // *cobra.command is the command itself,args is for flags from command line
	...
	getCmd = &cobra.Command{ //subcommand to be worked with itldims
		...
		Run: func(cmd *cobra.Command, args []string) { //the cobra.Command for
