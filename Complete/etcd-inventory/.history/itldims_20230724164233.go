...
// func getServerData(serverIP, attribute string) {
// 	// Connect to etcd
// 	ctx := context.TODO()
// 	etcdClient, err := clientv3.New(clientv3.Config{
// 		Endpoints: []string{etcdHost},
...
// 	etcdKeyData := fmt.Sprintf("/servers/%s/%s/%s", serverIP, attribute)
...
// 	serverIP := cmd.String("ipa", "", "Server IP")
// 	attribute := cmd.String("attr", "", "Attribute")
// 	cmd.Parse(os.Args[1:])

// 	if cmd.Parsed() {
// 		if *serverIP == "" || *attribute == "" {
// 			log.Fatal("Server IP and attribute must be provided")
// 		}

// 		// Retrieve data from etcd based on the provided server IP and attribute
// 		getServerData(*serverIP, *attribute)
// 	}
// }
