...
import (
	"context"               //for managing contexts to te 
	"encoding/csv"          // for CSV file handling in convertExcelToCSV and uploadToEtcd functions
...
func convertExcelToCSV(excelFile, csvFile string) {
	...
	// Go throuhg sheets and rows in the Excel file
